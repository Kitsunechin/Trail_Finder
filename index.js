...
function displayResults(responseJson_2) {
    ...
    if (trails.length === 0) {
      ...
      $('#results-list').append(
        ...
        <p class="style-label">Difficulty:<span>${trails[i].difficulty}, learn more <a target="_blank" href="https://signsofthemountains.com/blogs/news/what-do-the-symbols-on-ski-trail-signs-mean">here <img class= "external-link" src="Assets/external.png" alt="icon" width="12"/></a></span></p>
